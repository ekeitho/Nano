...
public class AlexandriaContract{
    ...
    public static final class BookEntry implements BaseColumns {
        ...
        public static final Uri FULLBOOK_CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_FULLBOOK).build();
        ...
        public static Uri buildFullBookUri(long id) {
            return ContentUris.withAppendedId(FULLBOOK_CONTENT_URI, id);
        }
